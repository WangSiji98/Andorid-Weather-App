...
public class SearchDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar = (Toolbar) findViewById(R.id.search_details_tool_bar4);
        toolbar.setTitle(city + ", " + WeatherMapper.getStateFullName(state));
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        TabLayout mTabLayout = findViewById(R.id.search_details_tab);
        ViewPager2 viewPager2 = findViewById(R.id.search_details_viewpage2);
